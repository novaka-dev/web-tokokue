      ...
      <!-- Menu navigasi -->
            <nav class="sidebar-nav">
                <ul class="sidebar-nav__list">
                    <li><a href="/index.php" class="sidebar-nav__link">Home</a></li>
                    <li><a href="/page/shop/shop.php" class="sidebar-nav__link">Shop</a></li>
                    <li><a href="../../#about" class="sidebar-nav__link">About Us</a></li>
                    <li><a href="/web-tokokue/#contact" class="sidebar-nav__link">Contact</a></li>
                    <li><a href="/page/cart/cart.php" class="sidebar-nav__link">Keranjang</a></li>
                </ul>
            </nav>
		</aside>
	</div>
