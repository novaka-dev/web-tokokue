...
<body>
	<footer class="footer-cake">
			...
			<div class="footer-right">
				...
				<div class="footer-right-child-container">
					...
					<div class="footer-right-child">
						...
						<a href="https://www.linkedin.com/company/ann-s-bakehouse-creamery/" class="footer-social">
							<svg xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" viewBox="0 0 24 24">
								<path d="M0 0h24v24H0z" fill="none" />
								<path fill="currentColor" d="M19 3a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2zm-.5 15.5v-5.3a3.26 3.26 0 0 0-3.26-3.26c-.85 0-1.84.52-2.32 1.3v-1.11h-2.79v8.37h2.79v-4.93c0-.77.62-1.4 1.39-1.4a1.4 1.4 0 0 1 1.4 1.4v4.93zM6.88 8.56a1.68 1.68 0 0 0 1.68-1.68c0-.93-.75-1.69-1.68-1.69a1.69 1.69 0 0 0-1.69 1.69c0 .93.76 1.68 1.69 1.68m1.39 9.94v-8.37H5.5v8.37z" />
							</svg>
						</a>
						<a href="https://www.facebook.com/annsbakehousejakarta" class="footer-social">
							<svg xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" viewBox="0 0 24 24">
								<path d="M0 0h24v24H0z" fill="none" />
						...
						<a href="https://www.youtube.com/@annsbakehousecreamery2712" class="footer-social">
							<svg xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" viewBox="0 0 24 24">
								<path d="M0 0h24v24H0z" fill="none" />
		...
		<div class="footer-bottom">
				Copyright <sup><small>&copy;</small></sup> 2024 Ann's Bakehouse & Creamery. All Rights Reserved.
		</div>
	</footer>
</body>
</html>